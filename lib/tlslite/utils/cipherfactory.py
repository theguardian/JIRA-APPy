...
from lib.tlslite.utils import python_aes
from lib.tlslite.utils import python_rc4

from lib.tlslite.utils import cryptomath

tripleDESPresent = False

if cryptomath.m2cryptoLoaded:
    from lib.tlslite.utils import openssl_aes
    from lib.tlslite.utils import openssl_rc4
    from lib.tlslite.utils import openssl_tripledes
    tripleDESPresent = True

if cryptomath.pycryptoLoaded:
    from lib.tlslite.utils import pycrypto_aes
    from lib.tlslite.utils import pycrypto_rc4
    from lib.tlslite.utils import pycrypto_tripledes
    tripleDESPresent = True
